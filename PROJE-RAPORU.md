...
> **Proje Kodu:** P31 · **Zorluk:** Zor · **Puan:** 55 · **Hafta:** 4
...
| GitHub | https://github.com/KULLANICI_ADI/final-p31-kotlin-ktor-ser |
...
#### 7.2.2 PostgreSQL + Exposed ORM veya Ktorm

*(Aynı format)*

---

#### 7.2.3 kotlinx.serialization
...
```mermaid
flowchart LR
    User(("👤 Android developer (Kotlin Multiplatform) / startup kurucusu"))
    System["<b>Kotlin Ktor Server</b>"]
